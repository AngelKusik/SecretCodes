...
- 📍 About this repository: SecretCodes is a repository created for a simple Python console application which was as a requirement for my Intro to Prog course (1st semester). This application will encode or decode a message entered by the user using Al Bhed characters.
